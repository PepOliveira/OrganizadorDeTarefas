...
- Remover tarefas.
- Pesquisa eficiente de tarefas utilizando Árvore Binária.
...
## Requisitos Utilizados de Estruturas de Dados
- Lista Simples Encadeada (implementada em `dataStructures.js`)
...
5. A aplicação será aberta no navegador selecionado por padrão.
